...
public class SessionController {
	...
	@GetMapping("/akhila/employees-akhila")
	public String employeesAkhilaPage(Model model) {
		model.addAttribute("apiBaseUrl", apiBaseUrl);
		return "employees-akhila";
	}

	@GetMapping("/akhila/employees-summary")
	public String employeesSummaryAkhilaPage(Model model) {
		model.addAttribute("apiBaseUrl", apiBaseUrl);
		return "employees-summary-akhila";
	}
